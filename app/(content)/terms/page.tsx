      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none prose-headings:font-be-vietnam-pro prose-headings:font-light prose-headings:tracking-tight prose-h2:text-xl prose-h2:mt-12 prose-h2:mb-4 prose-p:text-muted-foreground prose-p:leading-relaxed prose-li:text-muted-foreground prose-a:text-foreground prose-a:font-medium prose-a:no-underline hover:prose-a:underline prose-strong:text-foreground prose-strong:font-medium">
          <p className="text-base text-foreground/80 leading-relaxed">
            Welcome to AJ. These Terms of Service govern your use of our website and services. By using AJ,
          ...
          <p>
            By accessing or using AJ, you acknowledge that you have read, understood, and agree to be bound by
            these Terms of Service. We reserve the right to modify these terms at any time, and such modifications shall
            be effective immediately upon posting. Your continued use of AJ after any modifications indicates your
            acceptance of the modified terms.
          </p>

          <h2>2. Description of Service</h2>
          <p>
            AJ is a minimalistic AI-powered search engine that helps users find information on the internet. Our
          ...
          <p>You agree not to use AJ to:</p>
          <ul>
          ...
          <p>While we strive to provide accurate and reliable information, AJ:</p>
          <ul>
          ...
          <p>
            ...
            AJ should not be used as the sole source for making important decisions, especially in professional,
            medical, legal, or financial contexts.
          </p>

          <h2>5. Intellectual Property</h2>
          <p>
            All content, features, and functionality of AJ, including but not limited to text, graphics, logos,
            icons, images, audio clips, and software, are the property of AJ or its licensors and are protected by
          ...
          <p>AJ relies on third-party services to provide its functionality:</p>
          <ul>
          ...
          <p>
            By using AJ, you acknowledge and agree that your data may be processed by these third-party services
          ...
          <p>
            AJ offers both free and paid subscription plans. For detailed pricing information, visit our{' '}
          ...
          <ul>
            ...
            <li>
              <strong>AJ Pro:</strong> $15/month subscription with unlimited searches and access to all AI models
            </li>
          </ul>
          <p>
          ...
          <p>
            <strong>Important:</strong> AJ does not store any payment card details, bank information, or other
          ...
          <h2>9. Privacy</h2>
          <p>
            Your use of AJ is also governed by our{' '}
            <Link href="/privacy-policy">Privacy Policy</Link>, which is incorporated into these Terms of Service by reference.
          </p>

          <h2>10. Limitation of Liability</h2>
          <p>
            To the maximum extent permitted by law, AJ shall not be liable for any indirect, incidental, special,
          ...
          <p>
            AJ is provided &quot;as is&quot; and &quot;as available&quot; without any warranties of any kind,
          ...
          <p>
            We reserve the right to suspend or terminate your access to AJ, with or without notice, for conduct
          ...
          <p>
            ...
            AJ operates, without regard to its conflict of law provisions.
          </p>
        ...
        <div className="mt-16 pt-8 border-t border-border">
          <p className="text-sm text-muted-foreground">
            By using AJ, you agree to these Terms of Service and our{' '}
