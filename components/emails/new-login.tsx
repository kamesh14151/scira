      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={section}>
            ...
            <Text style={paragraph}>
              This is a routine security alert. Someone logged into your AJ AI account from a new IP address:
            </Text>
          </Section>
          ...
          <Section style={section}>
            <Text style={paragraph}>
              ...
              <Link href="https://scira-jade-one.vercel.app/settings" style={link}>
...
NewLoginEmail.PreviewProps = {
  userName: 'John Doe',
  loginTime: 'Sun, 12 Feb 2026 04:06:55 +0000',
