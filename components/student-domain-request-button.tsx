...
`
    : ''
}I am a current student at this university and would love to access the student discount for AJ Pro.
...
Best regards`;
  ...
  const handleSubmit = () => {
    ...
    const mailtoLink = `mailto:support@scira-jade-one.vercel.app?subject=${encodeURIComponent(subject)}&body=${formattedBody}`;
